...
bush_amount = int(input('Количество кустов: '))
berries_list = [int(input('кол-во ягод на 1 кусте на грядке: '))
...
for berries in range(2, len(berries_list)):
    res = berries_list[berries] + \
        berries_list[berries - 1] + berries_list[berries - 2]
    res_list.append(res)
print(max(res_list))

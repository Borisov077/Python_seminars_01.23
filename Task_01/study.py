...
# выведите «Неверная операция». Если пользователь захочет поделить на ноль,
...
# elif operation == '*':
#     print(num1*num2)
# elif operation == '/' and num1 == 0 or num2 == 0:
#     print("На ноль делить нельзя!")
# else:
#     print(num1/num2)
# if operation != '+' and operation != '-' and operation != '*' and operation != '/':
#     print('Неврная операция')
